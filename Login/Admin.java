...
public class Admin implements ActionListener{
    ...
    public Admin() {
        ...
        JLabel adminlLabel = new JLabel("ADMIN REGISTRATION");
        adminlLabel.setBounds(100, 70, 350, 30);
        frame.add(adminlLabel);
        adminlLabel.setFont(new Font("Times New Roman", Font.BOLD, 25));
        adminlLabel.setForeground(Color.BLACK);
        adminlLabel.setOpaque(false);
...
frame.setIconImage(icon.getImage());
    ...
    private void register() {
        ...
        String filePath = newUser.getName() + "_vehicles.txt";
