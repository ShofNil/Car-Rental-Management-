...
public class Registration extends frameDesign implements ActionListener { 
   ...
   public Registration(){
    ...
    b1 = button_design(b1, "Register as a staff", 410, 350, 200, 40, Color.WHITE, Color.BLACK);
    ...
    ImageIcon background = new ImageIcon("3.gif");
...
public void actionPerformed(ActionEvent e) {
        if (e.getSource() instanceof JButton) {
            ...
            if (button.getText().equals("Register as a staff")) {
                frame.dispose();
                new staff();
